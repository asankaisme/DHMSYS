		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">District Hospital, Matara</h2>
				</div>
			</div>
			<div class="row justify-content-center">
                  ...
                  <form method="POST" action="{{ route('login') }}">
                    @csrf
		      		<div class="form-group">
		      			...
		      			<input type="email" name="email" id="email" class="form-control rounded-left" placeholder="Your email" required>
		      		</div>
	            <div class="form-group">
